    ...
    var AnchorForm = MediumEditor.extensions.form.extend({
        ...
        handleClick: function (event) {
            ...
            if (range.startContainer.nodeName.toLowerCase() === 'a' ||
                ...
                /* webedit */
                /* workaround: for anchor with contenteditable attribute, we still keep its attributes */
                var node = MediumEditor.util.getClosestTag(
                ...
                if(node.getAttribute("contenteditable") == "true") {
                  ...
                  for(var i=0,name,value;i<node.attributes.length;i++) {
...
(function () {
    ...
    MediumEditor.prototype = {
        ...
        selectElement: function (element) {
            /* webedit */
            /* workaround: contenteditable inside medium-editor blocks selection. */
            /* clear it since it is generated by repeat-item syntax */
            element.removeAttribute("contenteditable");
            /* webedit */
